...
fn engie_acquatics_ftp_test() -> Result<()> {
    ...
    db_src.set_property("start_time", "2017-09-25T00:00:00+00:00")?;
    ...
    //csv_file_element.set_property("max_number_of_lines", "288")?;
    ...
    let mut pipeline = Pipeline::new("engie_aquatics".to_string(), PipelineRunType::SCHEDULED, true);
...
#[test]
fn engie_acquatics_ftp_test1() {

    pretty_env_logger::init().unwrap();

    println!("running engie aquatics ftp");
    if let Err(ref e) = engie_acquatics_ftp_test() {
