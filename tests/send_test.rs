...
fn send_test() -> Result<()> {
    ...
    db_src.set_property("aggregate_value", "AVG")?;
    ...
    let mut pipeline = Pipeline::new("send_test".to_string(), PipelineRunType::SCHEDULED, false);
